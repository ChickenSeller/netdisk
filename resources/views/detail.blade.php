                        ...
                        if((!isset($file)) || $file==null){
                            ...
                            <div class=\"col-lg-12\">
                                <p>
                                  ...
                                  $file->filename,$file->view_times,$file->uploader,$file->download_times,$file->created_at,$file->size,'download?file_id='.$file->id, $file->description);
                            echo $string;
